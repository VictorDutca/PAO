...
void DelegateDelete::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DelegateDelete *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (DelegateDelete::*)(int );
...
QT_INIT_METAOBJECT const QMetaObject DelegateDelete::staticMetaObject = { {
    &DelegateButton::staticMetaObject,
    qt_meta_stringdata_DelegateDelete.data,
    qt_meta_data_DelegateDelete,
    qt_static_metacall,
    nullptr,
    nullptr
} };
