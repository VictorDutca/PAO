...
void DelegateView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DelegateView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (DelegateView::*)(int );
...
QT_INIT_METAOBJECT const QMetaObject DelegateView::staticMetaObject = { {
    &DelegateButton::staticMetaObject,
    qt_meta_stringdata_DelegateView.data,
    qt_meta_data_DelegateView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
