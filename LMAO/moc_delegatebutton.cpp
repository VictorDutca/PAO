/****************************************************************************
** Meta object code from reading C++ file 'delegatebutton.h'
**
...
#include "../MODEL/delegatebutton.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'delegatebutton.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 15, 18), // "TableButtonPressed"
QT_MOC_LITERAL(2, 34, 0) // ""

    },
    "DelegateButton\0TableButtonPressed\0"
};
...
void DelegateButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->TableButtonPressed((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (DelegateButton::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DelegateButton::TableButtonPressed)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject DelegateButton::staticMetaObject = {
    { &QItemDelegate::staticMetaObject, qt_meta_stringdata_DelegateButton.data,
      qt_meta_data_DelegateButton,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void DelegateButton::TableButtonPressed(int _t1)
{
